...
#download rf
cd $downlooad_dir && if [ ! -d "./momlib-python/" ];then
...
cd .. && rm -rf ./dockerfile_rf/x86rgos && rm -rf ./dockerfile_rf/site-packages \
&& mv ./dockerfile_mom/x86rgos ./dockerfile_rf \
&& mv ./dockerfile_mom/site-packages ./dockerfile_rf
